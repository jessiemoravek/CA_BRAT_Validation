...
#Subset data for segments with observed capacity and stream segments => 299
subset_OG <- subset(OG, DamKM != 0 & iGeo_Len >= 299)
subset_REACH <- subset(REACH, DamKM != 0 & iGeo_Len >= 299)
subset_UNI <- subset(UNI, DamKM != 0 & iGeo_Len >= 299)

#Subset data for stream segments => 299
geo_OG <- subset(OG, iGeo_Len >= 299)
geo_REACH <- subset(REACH, iGeo_Len >= 299)
geo_UNI <- subset(UNI, iGeo_Len >= 299)
```
...
```{r}
#Subset data for segments with observed capacity and stream segments => 299
subset_OG_18090101 <- subset(OG_18090101, DamKM != 0 & iGeo_Len >= 299)
subset_REACH_18090101 <- subset(REACH_18090101, DamKM != 0 & iGeo_Len >= 299)
subset_UNI_18090101 <- subset(UNI_18090101, DamKM != 0 & iGeo_Len >= 299)

#Subset data for stream segments => 299
geo_OG_18090101 <- subset(OG_18090101, iGeo_Len >= 299)
geo_REACH_18090101 <- subset(REACH_18090101, iGeo_Len >= 299)
geo_UNI_18090101 <- subset(UNI_18090101, iGeo_Len >= 299)
```
...
```{r}
#Subset data for segments with observed capacity and stream segments => 299
subset_OG_18070302 <- subset(OG_18070302, DamKM != 0 & iGeo_Len >= 299)
subset_REACH_18070302 <- subset(REACH_18070302, DamKM != 0 & iGeo_Len >= 299)
subset_UNI_18070302 <- subset(UNI_18070302, DamKM != 0 & iGeo_Len >= 299)

#Subset data for stream segments => 299
geo_OG_18070302 <- subset(OG_18070302, iGeo_Len >= 299)
geo_REACH_18070302 <- subset(REACH_18070302, iGeo_Len >= 299)
geo_UNI_18070302 <- subset(UNI_18070302, iGeo_Len >= 299)
```
