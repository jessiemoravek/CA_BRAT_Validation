...
## Summary for Table XX
```{r}
Non_Zero_OG <- subset(OG, DamKM != 0)
nrow(Non_Zero_OG)
nrow(OG)
pctDams <- nrow(Non_Zero_OG)/nrow(OG)
pctDams
subset_OG <- subset(OG, DamKM != 0 & iGeo_Len >= 40)
nrow(subset_OG)
mean(subset_OG$iGeo_Len)
sum(OG$Join_Count)
#join count in entire watershed = 98
```
...
```{r}
Non_Zero_OG_18090101 <- subset(OG_18090101, DamKM != 0)
nrow(Non_Zero_OG_18090101)
nrow(OG_18090101)
pctDams <- nrow(Non_Zero_OG_18090101)/nrow(OG_18090101)
pctDams
subset_OG_18090101 <- subset(OG_18090101, DamKM != 0 & iGeo_Len >= 40)
nrow(subset_OG_18090101)
mean(subset_OG_18090101$iGeo_Len)
sum(OG_18090101$Join_Count)
#join count in entire watershed = 126
```
...
MLR_oCC_EX(subset_OG_18090101, "Original BRAT")
...
```{r}
Non_Zero_OG_18070302 <- subset(OG_18070302, DamKM != 0)
nrow(Non_Zero_OG_18070302)
nrow(OG_18070302)
pctDams <- nrow(Non_Zero_OG_18070302)/nrow(OG_18070302)
pctDams
subset_OG_18070302 <- subset(OG_18070302, DamKM != 0 & iGeo_Len >= 40)
nrow(subset_OG_18070302)
mean(subset_OG_18070302$iGeo_Len)
sum(OG_18070302$Join_Count)
#join count in entire watershed = 48
```
...
```{r}
Non_Zero_OG_18060005 <- subset(OG_18060005, DamKM != 0)
nrow(Non_Zero_OG_18060005)
nrow(OG_18060005)
pctDams <- nrow(Non_Zero_OG_18060005)/nrow(OG_18060005)
pctDams
subset_OG_18060005 <- subset(OG_18060005, DamKM != 0 & iGeo_Len >= 40)
nrow(subset_OG_18060005)
mean(subset_OG_18060005$iGeo_Len)
sum(OG_18060005$Join_Count)
#join count in entire watershed = 208
```
...
```{r}
Non_Zero_OG_18050002 <- subset(OG_18050002, DamKM != 0)
nrow(Non_Zero_OG_18050002)
nrow(OG_18050002)
pctDams <- nrow(Non_Zero_OG_18050002)/nrow(OG_18050002)
pctDams
subset_OG_18050002 <- subset(OG_18050002, DamKM != 0 & iGeo_Len >= 40)
nrow(subset_OG_18050002)
mean(subset_OG_18050002$iGeo_Len)
sum(OG_18050002$Join_Count)
#join count in entire watershed = 30
```
...
```{r}
Non_Zero_OG_18030002 <- subset(OG_18030002, DamKM != 0)
nrow(Non_Zero_OG_18030002)
nrow(OG_18030002)
pctDams <- nrow(Non_Zero_OG_18030002)/nrow(OG_18030002)
pctDams
subset_OG_18030002 <- subset(OG_18030002, DamKM != 0 & iGeo_Len >= 40)
nrow(subset_OG_18030002)
mean(subset_OG_18030002$iGeo_Len)
sum(OG_18030002$Join_Count)
#join count in entire watershed = 356
```
...
```{r}
Non_Zero_OG_18020163 <- subset(OG_18020163, DamKM != 0)
nrow(Non_Zero_OG_18020163)
nrow(OG_18020163)
pctDams <- nrow(Non_Zero_OG_18020163)/nrow(OG_18020163)
pctDams
subset_OG_18020163 <- subset(OG_18020163, DamKM != 0 & iGeo_Len >= 40)
nrow(subset_OG_18020163)
mean(subset_OG_18020163$iGeo_Len)
sum(OG_18020163$Join_Count)
#join count in entire watershed = 11
```
...
```{r}
Non_Zero_OG_18020123 <- subset(OG_18020123, DamKM != 0)
nrow(Non_Zero_OG_18020123)
nrow(OG_18020123)
pctDams <- nrow(Non_Zero_OG_18020123)/nrow(OG_18020123)
pctDams
subset_OG_18020123 <- subset(OG_18020123, DamKM != 0 & iGeo_Len >= 40)
nrow(subset_OG_18020123)
mean(subset_OG_18020123$iGeo_Len)
sum(OG_18020123$Join_Count)
#join count in entire watershed = 310
```
...
```{r}
Non_Zero_OG_18020002 <- subset(OG_18020002, DamKM != 0)
nrow(Non_Zero_OG_18020002)
nrow(OG_18020002)
pctDams <- nrow(Non_Zero_OG_18020002)/nrow(OG_18020002)
pctDams
subset_OG_18020002 <- subset(OG_18020002, DamKM != 0 & iGeo_Len >= 40)
nrow(subset_OG_18020002)
mean(subset_OG_18020002$iGeo_Len)
sum(OG_18020002$Join_Count)
#join count in entire watershed = 262
```
